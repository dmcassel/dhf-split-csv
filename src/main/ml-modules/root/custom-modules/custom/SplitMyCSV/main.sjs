...
function main(content, options) {
  ...
  */
  ...
  xdmp.log("SplitMyCSV -- I have the content")
  ...
  // return newContent;
  let lines = csv.split(doc);
  return lines.map(line => {
    xdmp.log("this line: " + xdmp.quote(line));
    xdmp.log("objectid" + line.OBJECTID);
    return {
        "uri": '/csv/' + line.OBJECTID + '.json',
        "value": line,
        context: {}
      }
  })
